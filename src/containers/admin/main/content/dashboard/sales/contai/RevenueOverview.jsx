              ...
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <span className="me-1 fw-bold" style={{ color: "#E35765" }}>
                    Doanh thu trong ngày {data.day.label}
                  </span>
                </div>
                <div className="d-flex justify-content-start align-items-center">
                  ...
                  <div>
                    ...
                    >
                      {Number(data.day.current).toLocaleString("vi-VN")}
                    </div>
                    <div
                      className={`${
                        Number(data.day.growth) > 0
                          ? "text-success"
                          : Number(data.day.growth) < 0
                          ? "text-warning"
                          : "text-muted"
                    ...
                    >
                      {Number(data.day.growth) > 0 && (
                        <>
                          ...
                          {Number(data.day.growth)}% so với ngày trước
                        </>
                      )}
                      ...
                      {Number(data.day.growth) < 0 && (
                        <>
                          ...
                          {Math.abs(Number(data.day.growth))}% so với ngày trước
                        </>
                      )}

                      {Number(data.day.growth) === 0 && <>Không thay đổi</>}
                    </div>
                  </div>
                </div>
              </Card.Body>
              ...
              <Card.Body>
                ...
                <div className="d-flex justify-content-start align-items-center">
                  ...
                  <div>
                    ...
                    >
                      {Number(data.week.current).toLocaleString("vi-VN")}
                    </div>
                    <div
                      className={`${
              ...
              <Card.Body>
                ...
                <div className="d-flex justify-content-start align-items-center">
                  ...
                  <div>
                    ...
                    >
                      {Number(data.month.current).toLocaleString("vi-VN")}
                    </div>
                    <div
                      className={`${
              ...
              <Card.Body>
                ...
                <div className="d-flex justify-content-start align-items-center">
                  ...
                  <div>
                    ...
                    >
                      {Number(data.year.current).toLocaleString("vi-VN")}
                    </div>
                    <div
                      className={`${
